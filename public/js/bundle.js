...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGFzaGlsYSIsImEiOiJjazE4NzJrd3UxajY0M2RwZmphNW9yZHBsIn0.G1EPnMmc5td2tJjKOIc3Zw';
...
// UPDATE DATA - type = 'password' or 'data'
var updateSettings =
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
...
var stripe = Stripe('pk_test_FQqcOuWn3lIwmA4iLKaNbm2f001V1buVwL');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:8000/api/v1/bookings/checkout-sesion/".concat(tourId));
...
var bookButton = document.getElementById('book-tour'); // MAPBOX
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); // UPDATE SETTINGS
